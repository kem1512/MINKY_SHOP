...
namespace MinkyShopProject.Admin.Pages.Admin
{
    ...
    public partial class VariantComponent
    {
        ...
        public async Task AddAsync()
        {
            if (await Validate())
            {
                var confirm = await Swal.FireAsync(new SweetAlertOptions { Title = "", TitleText = "Bạn Có Chắc Muốn Thêm", ShowConfirmButton = true, ShowCancelButton = true, Icon = SweetAlertIcon.Warning });
